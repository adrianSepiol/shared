...
import { DatasourcePlugin, OptionsEditorProps, VariablePlugin, VariableOption } from '../../../model';
...
const ErnieDatasource: DatasourcePlugin<ErnieDatasourceSpec> = {
  ...
  OptionsEditorComponent: function ErnieDatasourceEditor({ value, onChange, testConnection }: OptionsEditorProps<ErnieDatasourceSpec>) {
    return (
      <div>
        ...
        />
        {testConnection && (
          <button onClick={testConnection}>test-connection-trigger</button>
        )}
      </div>
    );
  },
